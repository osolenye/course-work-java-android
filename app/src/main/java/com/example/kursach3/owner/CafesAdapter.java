...
public class CafesAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Button btn_owner_cafe_delete = (Button) convertView.findViewById(R.id.btn_owner_cafe_delete);

        key = cafes.get(position).getKey();
        btn_owner_cafe_delete.setOnClickListener(new View.OnClickListener() {
            @Override
